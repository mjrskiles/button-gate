 ...
 * Index: 0=10ms, 1=20ms, 2=50ms (default), 3=1ms
 */
static const uint16_t TRIGGER_PULSE_VALUES[] PROGMEM_ATTR = {10, 20, 50, 1};
 ...
 * Index: 0=60BPM (1000ms), 1=80BPM (750ms), 2=100BPM (600ms, default),
